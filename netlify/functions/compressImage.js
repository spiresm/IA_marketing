...
exports.handler = async (event, context) => {
    ...
    try {
        // --- DÉBUT DE LA CORRECTION ULTRA-SIMPLIFIÉE ---
        // Si le frontend envoie Content-Type: application/json,
        // Netlify fournit event.body directement comme une chaîne JSON.
        const requestBody = JSON.parse(event.body);
        // --- FIN DE LA CORRECTION ULTRA-SIMPLIFIÉE ---
